...
class ChurchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create church" do
    assert_difference('Church.count') do
      post churches_url, params: { church: { address: @church.address, name: @church.name } }, as: :json
    end
  ...
  test "should update church" do
    patch church_url(@church), params: { church: { address: @church.address, name: @church.name } }, as: :json
    assert_response 200
  end
